          ...
          <div className="space-y-4">
            {analyticsData.topContent.map((item, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <Badge tone={item.growth > 0 ? 'green' : 'red'}>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-2">
                <Typography variant="body">Рост контента</Typography>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <Typography variant="body">Качество контента</Typography>
                <Typography variant="body" className="text-blue-600">
                  87%
                </Typography>
              </div>
              <Progress value={87} variant="default" className="h-2" />
            </div>

            <div>
              <div className="flex justify-between items-center mb-2">
                <Typography variant="body">Пользовательская активность</Typography>
                <Typography variant="body" className="text-purple-600">
                  94%
                </Typography>
              </div>
              <Progress value={94} variant="default" className="h-2" />
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
              ...
              <Badge tone="primary">Перезагрузка</Badge>
            </div>
